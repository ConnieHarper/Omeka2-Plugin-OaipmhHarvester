...
<div id="primary">
    ...
    <form method="post" action="<?php echo url('oaipmh-harvester/index/harvest'); ?>">
        ...
        <?php echo $this->formSubmit('submit_harvest', 'Harvest Repository'); ?>
    </form>
    <br />
    </p>
    <h3>Harvest a set:</h3>
    ...
    if ($set->setDescription 
		...
		<form method="post" action="<?php echo url('oaipmh-harvester/index/lists'); ?>">
                <?php echo html_escape($set->setSpec); ?></td>
		<td>
                <?php echo $this->formSelect('metadata_spec', null, null, $this->availableMaps); ?>
		</td>
		<td>
		<?php echo $this->formText('search_text', null, array('size' => 30)); ?>
