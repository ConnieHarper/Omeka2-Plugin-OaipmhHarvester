...
class OaipmhHarvester_Request
{
    ...
    /**
     * List one record for a given request with a specific identifier.
     *
     * @param array $query Args may include: metadataPrefix, identifier.
     */
